...
public class Registro_Autor extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst.setString(1, txt_idautor.getText().trim());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Connection cn=DriverManager.getConnection("jdbc:mysql://localhost/Film_Magic","root", "admin");
            PreparedStatement pst= cn.prepareStatement("update Autor set ID_Autor=?, Nombre_Autor=?, Apellido_Autor=?, Ciudad_Nacimiento=? where ID_Autor= "+ID);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txt_ciudad.setText(rs.getString("Ciudad_Nacimiento"));
